 ...
 */
$system['default_controller'] = 'index';
/**
 * 默认控制器方法名称,不要带前缀
 */
 ...
 */
$system['db']['default']['dbdriver'] = "mysqli";
$system['db']['default']['hostname'] = 'rdsu29q7ceiueja560kl.mysql.rds.aliyuncs.com';
$system['db']['default']['port'] = '3306';
$system['db']['default']['username'] = 'r1ow1xtl84';
$system['db']['default']['password'] = 'QQQqqq111';
$system['db']['default']['database'] = 'r1ow1xtl84';
$system['db']['default']['dbprefix'] = 'eup';
